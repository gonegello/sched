...
//Get total
$totalRecords = $class_year->getTotal($whereCondition, $sortBy);

//Get all tsag
$results = $class_year->getJoinWhere($whereCondition, $sortBy, $start, $length);
$data = [];
...
$baseUrl = $protocol . $_SERVER['HTTP_HOST'] . '/views/class-year/'.$btnAction.'.php?' . $urlFormer;
