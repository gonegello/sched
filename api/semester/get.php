...
//Get total
$totalRecords = $semester->getTotal($whereCondition, $sortBy);

//Get all tsag
$results = $semester->getJoinWhere($whereCondition, $sortBy, $start, $length);
$data = [];
...
$baseUrl = $protocol . $_SERVER['HTTP_HOST'] . '/views/semester/'.$btnAction.'.php?' . $urlFormer;
