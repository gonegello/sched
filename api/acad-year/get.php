...
//Get total
$totalRecords = $acad_year->getTotal($whereCondition, $sortBy);

//Get all tsag
$results = $acad_year->getJoinWhere($whereCondition, $sortBy, $start, $length);
$data = [];
...
$baseUrl = $protocol . $_SERVER['HTTP_HOST'] . '/views/academic-year/'.$btnAction.'.php?' . $urlFormer;
