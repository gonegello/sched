...
//Get all tsag
$results = $individual_records->getDeathInfo($whereCondition, $sortBy, $start, $length);
$data = [];
foreach($results AS $row) {
    ...
    $view_url = BASE_URL . '/views/reports/individual-death-information-report/print.php?id=' . $encryptedId;
    $action = '';
