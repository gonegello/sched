...
$house_type  = isset($_POST['house_type']) ? $_POST['house_type'] : '';
$house_location  = isset($_POST['house_location']) ? $_POST['house_location'] : '';
...
if(!empty($house_type) && !empty($house_location)) {
    $whereCondition .= " AND ( ht.name LIKE '%". $house_type ."%' )";
    $whereCondition .= " AND ( hl.name LIKE '%". $house_location ."%' )";
