...
if(!empty($purok))
{
    $whereCondition .= " AND ( p.no_street_sitio_purok LIKE '%". $purok ."%' )";
}
...
foreach($results AS $row) {
    ...
    $action = '';
    $action .= '<a class="btn btn-circle btn-sm btn-primary btn-print-in" data-id="'. $row['personal_info_id'] .'" data-href="'. $view_url .'"><i class="bi bi-printer"></i></a>';
    $action .= '';
