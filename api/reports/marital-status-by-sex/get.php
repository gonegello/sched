...
#if marital status is empty but sex is not
if($marital_status == '' && $sex == 'F'){
        $whereCondition .= " AND ( cs.name LIKE '%". $marital_status ."%')";
        $whereCondition .= " AND ( gender LIKE '%". $sex ."%')";
}
if($marital_status == '' && $sex == 'M'){
    $whereCondition .= " AND ( cs.name LIKE '%". $marital_status ."%' )";
    $whereCondition .= " AND ( gender LIKE '%". $sex ."%')";

}
#if sex is empty but marital status is not

if(!empty($marital_status)  && $sex == ''){
    $whereCondition .= " AND ( cs.name LIKE '%". $marital_status ."%' )";
    $whereCondition .= " AND ( gender LIKE '%". $sex ."%')";
}

if(!empty($marital_status)  && $sex == 'F'){
    $whereCondition .= " AND ( cs.name LIKE '%". $marital_status ."%' )";
    $whereCondition .= " AND ( gender LIKE '%". $sex ."%')";
}if(!empty($marital_status)  && $sex == 'M'){
    $whereCondition .= " AND ( cs.name LIKE '%". $marital_status ."%' )";
    $whereCondition .= " AND ( gender LIKE '%". $sex ."%')";
}
