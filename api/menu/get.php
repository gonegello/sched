...
foreach($results AS $row) {
    ...
    $action = '<a class="btn btn-circle btn-sm btn-success btn-add" href="/views/settings/menu/sub-menu/?id='.$encryptedId.'"><i class="bi bi-plus-lg"></i></a>';
    $action .= '&nbsp; <a class="btn btn-circle btn-sm btn-primary btn-edit" data-id="'. $row['id'] .'" data-name="'. $row['name'] .'" data-url="'. $row['url']  .'" data-icon="'. $row['icon'] .'" data-sort="'. $row['sort'] .'" data-status="'. $row['is_active'] .'" data-active-keyword="'. $row['active_keyword'] .'">
