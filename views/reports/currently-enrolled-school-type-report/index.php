...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>Currently Enrolled By Age and Sex and School Type Records</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo BASE_URL ?>">Home</a></li>
                <li class="breadcrumb-item active">Currently Enrolled By Age and Sex and School Type Records</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
        ...
        <div class="row">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Currently Enrolled By Age and Sex and School Type Records</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select id="school_type" name="school_tyle" class="form-control" style="width: 100%;">
...
<script>
    $(document).ready(function(){
        var table = $('#table-data').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo BASE_URL ?>/api/reports/currently-enrolled-school-type-report/get.php',
                type: 'POST',
                data : function ( d ) {
                    return $.extend( {}, d, {
        ...
        $(document).on('click', '#submit', function(){
            ...
            table.ajax.reload();
            var sex = $('#sex').val();
            var grade = $('#school_type').val();
            var age = $('#age').val();
            var url = 'print.php?sex='+sex+'&school_type='+grade+'&age='+age;
            console.log(sex);
            console.log(grade);
            console.log(age);
            console.log(url);
