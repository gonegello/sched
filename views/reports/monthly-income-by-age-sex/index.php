...
$resmonthly_income = $monthly_income->getWhere(" AND status = 'A'");
...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>Monthly Income (15 years old and above) By Age and Sex Records</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo BASE_URL ?>">Home</a></li>
                <li class="breadcrumb-item active">Monthly Income (15 years old and above) By Age and Sex Records</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
        ...
        <div class="row">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Monthly Income (15 years old and above) By Age and Sex Records</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select id="monthly" name="monthly" class="form-control" style="width: 100%;">
                                    <option value="">All</option>
                                         <?php foreach($resmonthly_income AS $row_r): ?>
...
<script>
    $(document).ready(function(){
        ...
        var table = $('#table-data').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo BASE_URL ?>/api/reports/monthly-income-by-age-sex/get.php',
                type: 'POST',
                data : function ( d ) {
                    return $.extend( {}, d, {
                        "monthly": $('#monthly').val(),
        ...
        $(document).on('click', '#submit', function(){
            ...
            table.ajax.reload();
            var type_val = $('#monthly').val();
            $('#print').data( 'val',type_val);
            var url = 'print.php?monthly='+type_val;
            $('#print').data( 'href',url);
