...
$rescivil_status = $civil_status->getWhere(" AND status = 'A'");
...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>Marital Status By Sex Records</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo BASE_URL ?>">Home</a></li>
                <li class="breadcrumb-item active">Marital Status By Sex Records</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
        ...
        <div class="row">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Marital Status By Sex Records</h5>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="marital_status" name="marital_status" class="form-control" style="width: 100%;">
                                                    <option value="">All</option>
                                                        <?php foreach($rescivil_status AS $row_r): ?>
...
<script>
    $(document).ready(function(){
        var table = $('#table-data').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo BASE_URL ?>/api/reports/marital-status-by-sex/get.php',
                type: 'POST',
                data : function ( d ) {
                    return $.extend( {}, d, {
        ...
        $(document).on('click', '#submit', function(){
            ...
            var url = 'print.php?sex='+sex+'&marital='+marital;
            console.log(sex);
            console.log(marital);
            console.log(url);
