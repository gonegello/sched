...
$resRecords = $records->getAllInfo(" AND p.registered_voter = 'Y'");
$male = $records->getAllInfo(" AND p.registered_voter = 'Y' AND p.gender = 'M'");
$female = $records->getAllInfo(" AND p.registered_voter = 'Y' AND p.gender = 'F'");
...
<head>
    ...
    <title>Report for List of Registered Voter | PRINT</title>
...
<table>
        <tr>
            <td colspan="10" style="text-align: center;border:none;"><h3>REPORT FOR LIST OF VOTERS</h3></td>
        </tr>
    </table>
    <table width="23%">
