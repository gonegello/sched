...
$resreligion = $religions->getWhere();
...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>Religious Affiliation By Sex</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo BASE_URL ?>">Home</a></li>
                <li class="breadcrumb-item active">Religious Affiliation By Sex</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
        ...
        <div class="row">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Religious Affiliation By Sex Records</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select id="religion" name="religion" class="form-control" style="width: 100%;">
                                                <option value="">All</option>
                                                    <?php foreach($resreligion AS $row_r): ?>
...
<script>
    $(document).ready(function(){
        var table = $('#table-data').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo BASE_URL ?>/api/reports/religious-aff-by-sex/get.php',
                type: 'POST',
                data : function ( d ) {
                    return $.extend( {}, d, {
        ...
        $(document).on('click', '#submit', function(){
            ...
            var url = 'print.php?sex='+sex+'&religion='+religion;
            console.log(sex);
