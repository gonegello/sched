...
$resRecords = $records->getAllInfo(" AND p.solo_parent = 'Y'");
$male = $records->getAllInfo(" AND p.solo_parent = 'Y' AND p.gender = 'M'");
$female = $records->getAllInfo(" AND p.solo_parent = 'Y' AND p.gender = 'F'");
...
<head>
    ...
    <title>Report for List of Solo Parent | PRINT</title>
...
<table>
        <tr>
            <td colspan="10" style="text-align: center;border:none;"><h3>REPORT FOR LIST OF SOLO PARENT</h3></td>
        </tr>
    </table>
    <table width="23%">
