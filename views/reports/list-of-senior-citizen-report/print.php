...
$resRecords = $records->getAllInfo(" AND p.registered_senior_citizen = 'Y'");
$male = $records->getAllInfo(" AND p.registered_senior_citizen = 'Y' AND p.gender = 'M'");
$female = $records->getAllInfo(" AND p.registered_senior_citizen = 'Y' AND p.gender = 'F'");
...
<head>
    ...
    <title>Report for List of Senior Citizen | PRINT</title>
...
<table>
        <tr>
            <td colspan="10" style="text-align: center;border:none;"><h3>REPORT FOR LIST OF SENIOR CITIZEN</h3></td>
        </tr>
    </table>
    <table width="23%">
