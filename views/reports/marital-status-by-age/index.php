...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>Marital Status By Age Records</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo BASE_URL ?>">Home</a></li>
                <li class="breadcrumb-item active">Marital Status By Age Records</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
        ...
        <div class="row">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Marital Status By Age Records</h5>
...
<script>
    $(document).ready(function(){
        var table = $('#table-data').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo BASE_URL ?>/api/reports/marital-status-by-age/get.php',
                type: 'POST',
                data : function ( d ) {
                    return $.extend( {}, d, {
        ...
        $(document).on('click', '#submit', function(){
            ...
            var url = 'print.php?age='+age+'&marital='+marital;
            console.log(age);
            console.log(marital);
            console.log(url);
