...
$resRecords = $records->getAllInfo(" AND p.4ps_member = 'Y'");
$male = $records->getAllInfo(" AND p.4ps_member = 'Y' AND p.gender = 'M'");
$female = $records->getAllInfo(" AND p.4ps_member = 'Y' AND p.gender = 'F'");
...
<head>
    ...
    <title>Report for List of 4Ps Member | PRINT</title>
...
<table>
        <tr>
            <td colspan="10" style="text-align: center;border:none;"><h3>REPORT FOR LIST OF 4Ps MEMBERS</h3></td>
        </tr>
    </table>
    <table width="23%">
