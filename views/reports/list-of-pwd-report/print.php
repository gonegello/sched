...
$resRecords = $records->getAllInfo(" AND p.pwd = 'Y'");

$male = $records->getAllInfo(" AND p.pwd ='Y' AND p.gender = 'M'");
$male_count = count($male);

$female = $records->getAllInfo(" AND p.pwd ='Y' AND p.gender = 'F'");
...
<head>
    ...
    <title>Report for List of PWD | PRINT</title>
...
<table>
        <tr>
            <td colspan="10" style="text-align: center;border:none;"><h3>REPORT FOR LIST OF PERSONS WITH DISABILITY (PWD)</h3></td>
        </tr>
    </table>
    <table width="23%">
