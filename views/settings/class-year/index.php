...
require (DOCUMENT_ROOT . '/models/Class_year.php');
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Class Year</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
        ...
        <div class="row">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Class Year</h5>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" id="frm-class-year" data-parsley-validate="">
...
<script>
    $(document).ready(function(){
        var table = $('#table-data').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo BASE_URL ?>/api/class-year/get.php',
                type: 'POST'
            },
            "columnDefs": [ {
                "targets": [3],
        ...
        $('#btn-save').click(function(){
            if(!$('form#frm-class-year').parsley().validate()) {
                return;
            }
            var msg = $('.error-message');
            $.ajax({
                url : '<?php echo BASE_URL ?>/api/class-year/dml.php',
                type : 'post',
                data : $('#frm-class-year').serialize(),
        ...
        $('#btn-add').click(function(){
            ...
            $('#modal-title').text('Add Class Year');
            $('.error-message').text('');
            $('#frm-class-year')[0].reset();
            $('#frm-class-year').parsley().reset();
...
$(document).on('click', '.btn-edit' ,function() {
        ...
        $('#frm-class-year').parsley().reset();
        $('.error-message').text('');
        $('#modal-title').text('Edit Class Year');
        $('#modal-add').modal('show');
    })
