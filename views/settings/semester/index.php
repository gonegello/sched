...
require (DOCUMENT_ROOT . '/models/Semester.php');
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" id="frm-semester" data-parsley-validate="">
...
<script>
    $(document).ready(function(){
        var table = $('#table-data').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo BASE_URL ?>/api/semester/get.php',
                type: 'POST'
            },
            "columnDefs": [ {
                "targets": [3],
        ...
        $('#btn-save').click(function(){
            if(!$('form#frm-semester').parsley().validate()) {
                return;
            }
            var msg = $('.error-message');
            $.ajax({
                url : '<?php echo BASE_URL ?>/api/semester/dml.php',
                type : 'post',
                data : $('#frm-semester').serialize(),
        ...
        $('#btn-add').click(function(){
            ...
            $('#modal-title').text('Add Semester');
            $('.error-message').text('');
            $('#frm-semester')[0].reset();
            $('#frm-semester').parsley().reset();
