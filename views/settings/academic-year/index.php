...
require (DOCUMENT_ROOT . '/models/Academic_year.php');
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" id="frm-acad-year" data-parsley-validate="">
...
<script>
    $(document).ready(function(){
        var table = $('#table-data').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo BASE_URL ?>/api/acad-year/get.php',
                type: 'POST'
            },
            "columnDefs": [ {
                "targets": [3],
        ...
        $('#btn-save').click(function(){
            if(!$('form#frm-acad-year').parsley().validate()) {
                return;
            }
            var msg = $('.error-message');
            $.ajax({
                url : '<?php echo BASE_URL ?>/api/acad-year/dml.php',
                type : 'post',
                data : $('#frm-acad-year').serialize(),
        ...
        $('#btn-add').click(function(){
            ...
            $('#modal-title').text('Add Acad Year');
            $('.error-message').text('');
            $('#frm-acad-year')[0].reset();
            $('#frm-acad-year').parsley().reset();
...
$(document).on('click', '.btn-edit' ,function() {
        ...
        $('#frm-acad-year').parsley().reset();
        $('.error-message').text('');
        $('#modal-title').text('Edit Acad Year');
        $('#modal-add').modal('show');
    })
